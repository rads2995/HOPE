...
// Declare and define initial guess vector {x0} for nonlinear function
array_type n_x0 = {10.0, 1.0, 1.0};

// Declare and define constant values for nonlinear function
constexpr double sigma = 10.0;
constexpr double R = 28.0;
constexpr double b = 8.0 / 3.0;

// Define functions for nonlinear integration
// nonlinear_system:
